...
<div  >
            ...
            <div className="flex justify-center">
                <Button className='bg-white bg-opacity-10 text-black border border-black hover:bg-white hover:bg-opacity-30 w-40 md:w-52 mb-16 h-12 rounded-3xl '>View All</Button>
            </div>
            <hr />
        </div>
