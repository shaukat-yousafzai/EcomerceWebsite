...
export default function Footer () {
    return (
        <footer className=' text-black pt-44 px-4'>
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-5 gap-10'>
                <div>
                    <h2 className='text-4xl font-bold mb-4'>SHOP.CO</h2>
                    <p className=' mb-5 gap-5'>We have clothes that suit your style and which you are proud to wear—from women to men.</p>
            ...
            <div className='mt-10 border-t border-gray-800  text-center'>
